...
const About = () => {
  return (
    <div className='flex flex-col items-center justify-center container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden text-center' id='About' >
            ...
            <div className='flex flex-col items-center md:items-start mt-10  text-gray-600 '>
                <div className='grid grid-cols-2 gap-6 md:gap-10 w-full 2xl:pr-28'>
                    ...
                    <p className='my-10 max-w-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                        Vero quaerat, quidem, sed quis ut natus nobis commodi 
                        autem maxime, veniam aliquid! Provident porro iusto 
                        obcaecati dolorum enim vel perspiciatis cumque?</p>
