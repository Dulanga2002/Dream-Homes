      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start ">
        <div className="w-full md:w-1/3 mb-8 md:mb-0">
          ...
          <p className="text-gray-400 mt-4">
            ...
            esse dolores in? Doloremque cum at, error quisquam est repudiandae
            nihil quas ea saepe nisi, fugiat molestias porro eligendi recusandae
            ratione.
          </p>
        </div>
        ...
        <div className="w-full md:w-1/3">
          ...
          <div className="flex gap-2 ">
            ...
            <button className="p-2 px-4 rounded bg-blue-500 text-white ">Subscribe</button>
          </div>
        </div>
      </div>
