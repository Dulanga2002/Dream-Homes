    ...
    >
      ...
      className="container  text-center mx-auto text-white py-4 px-6 md:px20 lg:px-32">
        ...
        <div className="space-x-6 mt-16 ">
          ...
          <a href="#Contact" className="px-8 py-3 rounded bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-sky-500/40 hover:scale-105 font-semibold">Contact Us</a>
        </div>
      </motion.div>
    </div>
  );
